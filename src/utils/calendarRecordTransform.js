...
export function transformAttendanceRangeRecord(r) {
  ...
  const checkOut = r.check_out_time
    ...
    : "--";
  const halfDay = getHalfDayDetails(r);
  ...
  return {
    ...
    half_day_effective_minutes: halfDay.effective,
    half_day_slot_checked: halfDay.slotChecked,
    half_day_invalid_reason: halfDay.invalidReason,
